...
import { prodevCards } from "../data/jrp"
...
function Rotations() {
    return <div className="px-20 pt-20 pb-20 border-b-2 border-cardinal">
        <h2 className="text-5xl font- text-center mb-12 text-cardinal">Rotations</h2>
