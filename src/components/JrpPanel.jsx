function JrpPanel() {
    return <>
    <div className="flex px-20 gap-20 pt-20">
        <a 
            href="#"
        ...
        <a
            href="#"
            className="transition-color duration-200 block border-2 border-cardinal bg-off-white text-dark p-4 shadow-[4px_4px_0_0,8px_8px_0_0,12px_12px_0_0] shadow-cardinal hover:translate-3 hover:bg-cardinal-mid hover:shadow-none hover:text-dark sm:p-6"
        >
            <span className="inline-flex items-center gap-1.5">
                <svg
                aria-hidden="true"
